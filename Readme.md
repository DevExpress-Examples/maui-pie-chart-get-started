<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/393342839/22.1.1%2B)
...
In the *MauiProgram.cs* file, call the **UseDevExpress** method to register a handler for the DevExpress PieChartView:
